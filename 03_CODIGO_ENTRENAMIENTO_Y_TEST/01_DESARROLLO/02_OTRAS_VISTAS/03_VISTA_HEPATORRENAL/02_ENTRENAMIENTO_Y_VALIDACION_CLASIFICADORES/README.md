# Training and validation: hepatorrenal
...
```powershell
python "03_CODIGO_ENTRENAMIENTO_Y_TEST/01_DESARROLLO/02_OTRAS_VISTAS/03_VISTA_HEPATORRENAL/02_ENTRENAMIENTO_Y_VALIDACION_CLASIFICADORES/train_validate.py" --artifact-root "PATH_TO_PRIVATE_THESIS_ARTIFACTS"
```
