# Training and validation: oblicua
...
```powershell
python "03_CODIGO_ENTRENAMIENTO_Y_TEST/01_DESARROLLO/02_OTRAS_VISTAS/02_VISTA_OBLICUA/02_ENTRENAMIENTO_Y_VALIDACION_CLASIFICADORES/train_validate.py" --artifact-root "PATH_TO_PRIVATE_THESIS_ARTIFACTS"
```
