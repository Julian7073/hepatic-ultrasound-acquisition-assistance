# Independent recorded-video test: hepatorrenal
...
```powershell
python "03_CODIGO_ENTRENAMIENTO_Y_TEST/02_VALIDACION_INDEPENDIENTE/02_OTRAS_VISTAS/03_VISTA_HEPATORRENAL/01_PIPELINE_PROCESAMIENTO_VIDEO_TEST_INDEPENDIENTE/reproduce_evaluation.py" --artifact-root "PATH_TO_PRIVATE_THESIS_ARTIFACTS"
```
